...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'volt-chat-workshop.com'
  config.app_name = 'Volt-chat-workshop'
  config.mailer.from = 'Volt-chat-workshop <no-reply@volt-chat-workshop.com>'
  ...
  #
  config.app_secret = 'RfeP6Oxjwh2YxEJhMSO4aV8H2Rj29nzchpiEuKA8iJvV4Z5-4Q6kiCF8tSO--DS2tA0'
